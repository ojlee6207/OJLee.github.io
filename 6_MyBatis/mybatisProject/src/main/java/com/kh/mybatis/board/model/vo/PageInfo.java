...
public class PageInfo {
	...
	private int currentPage;	// 현재 페이지(사용자로부터 요청시 전달될 값)
	private int pageLimit;		// 페이지 하단에 표시된 페이징바의 최대 수
	private int boardLimit;		// 한 페이지에 표시할 게시글의 최대 갯수
	private int maxPage;		// 가장 마지막 페이지(총 페이지 수)
	private int startPage;		// 페이징바의 시작 번호
	private int endPage;		// 페이징바의 마지막 번호
