				...
				function selectReplyList() {
					...
					$.ajax({
						...
						success: function(result) {
							$("#usId").text(result.replyWriter);
							$("#repContent").text(result.replyContent);
							$("#repDay").text(result.createDate);
						},
						error: function() {
				...
				function sendPostReply() {
					...
					$.ajax({
						...
						data: {
							...
							bnum: boardNo,
							replyWriter : repWriter
						},
						success: function(result) {
							$("#usId").append(result.replyWriter);
							$("#repContent").append(result.replyContent);
							$("#repDay").append(result.createDate);
						},
						error: function() {
							console.log("Connection Fail#3");
						}
