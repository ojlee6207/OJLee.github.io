...
<body>
	...
	그대로 출력 : ${now}<br>
	<ul>
		<li>현재 날짜 : <fmt:formatDate value="${now}"/></li> <!-- type 생략 시 날짜만 표시 -->
		<li>현재 시간 : <fmt:formatDate value="${now}" type="time"/></li>
		<li>현재 날짜+시간 : <fmt:formatDate value="${now}" type="both"/></li>
		<li>medium style : <fmt:formatDate value="${now}" type="both" dateStyle="medium" timeStyle="medium"/></li>
		<li>Long style : <fmt:formatDate value="${now}" type="both" dateStyle="long" timeStyle="long"/></li>
		<li>Full style : <fmt:formatDate value="${now}" type="both" dateStyle="full" timeStyle="full"/></li>
		<li>Short style : <fmt:formatDate value="${now}" type="both" dateStyle="short" timeStyle="short"/></li>
		<li>my style : <fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd(E) HH:mm:ss(a)"/></li>
