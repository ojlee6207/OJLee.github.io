 ...
 * Generated at: 2024-03-28 02:49:36 UTC
...
public final class _01_005fel_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("	<h3>* 기존 방식인 스크립트릿과 표현식을 이용해서 각 scope에 있는 데이터 출력</h3>\r\n");
      out.write("	");
      out.write("\r\n");
      out.write("	<h3>*EL을 사용하여 각 scope의 데이터 출력하기</h3>\r\n");
      out.write("	<p>\r\n");
      out.write("		EL을 이용하면 getXXX 메소드를 사용하지 않고, EL구만 내에서 해당 키값만 제시하면 바로 접근 가능<br>\r\n");
      out.write("		기본적으로 EL은 jsp 내장 객체를 구분하지 않고, 모든 내장 객체에 키 값을 검색하여 존재하는 경우\r\n");
      out.write("		해당 데이터를 가지고 옴\r\n");
      out.write("	</p>\r\n");
      out.write("	<p>\r\n");
      out.write("		학원명: ");
      ...
      out.write(" <br>\r\n");
      out.write("		<!-- \r\n");
      out.write("			teacher 데이터에 접근하면 Person 객체로,\r\n");
      out.write("			해당 객체의 필드에 담긴 값을 출력하고자 할 때 .필드명으로 접근\r\n");
      out.write("			=> 내부적으로 해당 필드의 getter 메소드를 찾아서 실행\r\n");
      out.write("			!! 주의 !! : getter 메소드는 항상 필수적으로 정의 되어 있어야 함.\r\n");
      out.write("		 -->\r\n");
      out.write("		<br>\r\n");
      out.write("		수강생 정보\r\n");
      out.write("		<ul>\r\n");
      ...
      out.write("	</p>\r\n");
      out.write("	<br>\r\n");
      out.write("	<h3>* EL 사용 시 내장 객체들에 동일한 키 값으로 저장된 데이터 접근하기</h3>\r\n");
      out.write("	scope값 : ");
      ...
      out.write(" <br>\r\n");
      out.write("	<!--  \r\n");
      out.write("		EL에서는 공유 범위가 가장 작은 scope부터 키값을 검색\r\n");
      out.write("		page -> request -> session -> application\r\n");
      out.write("		만약 모든 영역에서 찾지 못하면..\r\n");
      out.write("		=> 아무것도 출력되지 않음(오류 X)\r\n");
      out.write("	 -->\r\n");
      out.write("	 test 값 : ");
      ...
      out.write(" <br>\r\n");
      out.write("	 <br>\r\n");
      out.write("	 <h3>* 직접 scope를 지정하여 접근하기</h3>\r\n");
      out.write("	 ");
      ...
      out.write("	 <br><br>\r\n");
      out.write("	 <!-- \r\n");
      out.write("	 		각 영역에 동일한 키 값으로 데이터를 저장한 경우,\r\n");
      out.write("	 		scope를 직접 지정하여 해당 키의 데이터를 가져올 수 있음. (xxxScope.키값)\r\n");
      out.write("	 		\r\n");
      out.write("	 		키값만 사용하는 경우 원하는 데이터를 조회하지 못할 수 있음\r\n");
      out.write("	  -->\r\n");
      out.write("	 접근을 잘못할 경우... (session 객체에 classRoom 데이터 조회) <br>\r\n");
      out.write("	 => ");
