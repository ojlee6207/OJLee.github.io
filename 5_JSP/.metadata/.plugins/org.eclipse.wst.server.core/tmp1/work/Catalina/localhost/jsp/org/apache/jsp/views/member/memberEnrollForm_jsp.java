 ...
 * Generated at: 2024-04-02 01:30:22 UTC
...
public final class memberEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1712021420827L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	}\r\n");
      out.write("\r\n");
      out.write("    /* margin:auto; => 가운데 정렬하고자 할 때 */\r\n");
	...
	System.out.println("=================");
        ...
        if (_jspx_eval_c_005fchoose_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            try {
              ...
              // /views/member/../common/menubar.jsp(73,9) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("				<td><button type=\"button\" onclick=\"checkUserId();\">중복확인</button></td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
      ...
      out.write("			<button type=\"submit\" onclick=\"return checkPwd();\" disable>회원가입</button>\r\n");
      ...
      out.write("				// 입력된 아이디 값 꺼내오기 (로그인 영역과 겹치므로 form 내의 input요소로 접근)\r\n");
      out.write("				const $userId = $(\"#enroll-form input[name=userId]\");\r\n");
      out.write("			\r\n");
      out.write("				$.ajax({\r\n");
      out.write("					url: 'idCheck.me',\r\n");
      out.write("					type: 'get',\r\n");
      out.write("					data: { checkId: $userId.val() },		// 전달데이터의 키값 : checkId, 데이터값 : userId\r\n");
      out.write("					success: function(result) {		// 중복되는 값이 있을 때는 YYY, 없을때는 NNN\r\n");
      out.write("						// 중복되지 않은 경우, 사용자에게 \"해당 아이디를 사용하시겠습니까?\" 질문 후\r\n");
      out.write("						// 사용하는 경우 회원가입 활성화\r\n");
      out.write("						console.log(result);\r\n");
      out.write("						if (result === \"NNN\") {\r\n");
      out.write("							if(confirm(\"해당 아이디를 사용하시겠습니까?\")) {\r\n");
      out.write("								$(\"#enroll-form :submit\").removeAttr(\"disabled\");	// disabled라는 속성 제거\r\n");
      out.write("								$userId.attr(\"readonly\", true);					// readonly 속성을 true로\r\n");
      out.write("							} else {\r\n");
      out.write("								$userId.focus();\r\n");
      out.write("							}\r\n");
      out.write("						} else {		// 중복되는 아이디가 있으면\r\n");
      out.write("							alert(\"이미 존재하는 아이디거나 탈퇴한 회원의 아이디입니다. 다시 입려개주세요.\");\r\n");
      out.write("							$userId.focus();\r\n");
      out.write("						}\r\n");
      out.write("					},\r\n");
      ...
      out.write("				// 비밀번호, 비밀번호 확인 요소 접근해서 값을 꺼내온 뒤\r\n");
      out.write("                let password = document.querySelector(\"#enroll-form input[name=userPwd]\");\r\n");
      out.write("                let passwordcheck = document.querySelector(\"#enroll-form input[name=userPwdCheck]\");\r\n");
      out.write("\r\n");
      out.write("				// let password = document.getElementsByName(\"userPwd\");\r\n");
      out.write("				// let passwordcheck = document.getElementsByName(\"userPwdCheck\");\r\n");
      out.write("\r\n");
      out.write("                // console.log(password)\r\n");
      out.write("                // console.log(passwordcheck)\r\n");
      out.write("				// 다른 경우 false를 리턴\r\n");
      out.write("				if (password.value != passwordcheck.value) {\r\n");
      out.write("					alert(\"비밀번호가 다릅니다. 확인 후 다시 입력해 주세요\");\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/member/../common/menubar.jsp(63,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fremove_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/member/../common/menubar.jsp(67,2) name = var type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fremove_005f0.setVar("alertMsg");
      // /views/member/../common/menubar.jsp(67,2) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
